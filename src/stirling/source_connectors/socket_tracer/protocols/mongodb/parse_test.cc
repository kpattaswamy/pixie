...
TEST_F(MongoDBParserTest, ParseFrameValidMongoDBResponse) {
...
TEST_F(MongoDBParserTest, ParseFrameValidMongoDBRequestTwoSections) {
  auto frame_view = CreateStringView<char>(CharArrayStringView<uint8_t>(mongoDBValidRequestTwoSections));
